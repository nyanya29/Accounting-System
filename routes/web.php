...
///
Route::get('checkdisbjournal', [JevdReportsController::class, 'checkDisbursementJournal']);
// Route::get('check-disb-journal', [JevdReportsController::class, 'jevdTypeReport']);